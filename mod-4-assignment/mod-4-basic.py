...
def savings(gross_pay, tax_rate, expenses):
    ...
    tax_rate /= 100
    savings = math.floor(gross_pay/tax_rate)-expenses
    savings *= 100
...
def interest(principal, rate, periods):
    ...
    principal *= 100
    rate /= 100
    final_value = math.floor(principal * rate * periods)

    return str(final_value) + " Centavos"
...
def body_mass_index(weight, height):
    ...
    height_m = (height[0]*12*2.54 + height[1]*2.54) / 100
